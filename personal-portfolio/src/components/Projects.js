...
import projImg2 from "../assets/img/project-img06.jpg";
...
import react from "../assets/img/img22.png";
...
export const Projects = () => {
  const projects = [
    ...
    {
      title: "Food Wast Management System (Mobile Aoolication)",
      description: "Design & Development",
      imgUrl: projImg2,
    },
    {
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                ...
                >
                  ...
                  <div class="container1">
                    <div class="square orange-square">
                      <div class="shadow-md hover:scale-105 duration-500 py-6 rounded-lg shadow-blue-500">
                        <img src={react} alt="css" class="w-20 mx-auto" />
                        <p class="mt-4">React</p>
                      </div>
                    </div>
                  ...
                  <h2>Projects</h2>
                  <p>
                    I worked on a variety of projects, refining my technical
                    skills and obtaining practical experience. I helped with
                    front-end development by using HTML, CSS, and JavaScript, as
                    well as frameworks like React.js for dynamic interfaces. In
                    addition, I used Node.js and Express.js to integrate backend
                    functions for rapid data retrieval. I used Git for version
                    management and took an active role in code reviews and
                    project planning. Overall, my internship provided me with
                    great experience in web development and teamwork.
                  </p>
